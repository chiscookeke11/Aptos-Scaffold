        ...
        <div className=" w-full h-screen fixed inset-0 flex items-center justify-center bg-black/75 z-40 px-5 py-10 font-space-grotesk " >
            ...
            <div className=" w-full max-w-xl bg-white rounded-md flex items-center flex-col px-4 py-4 pb-7 gap-5 " >
                ...
                <div className="flex flex-col items-start w-full gap-3" >
                    <ConnectButton setShowModal={setShowModal} variant="default" className="w-full flex items-center gap-2" ><span>Connect Petra Wallet</span> <Image src={"/logo/pectra-logo.png"} alt="Aptos-Scaffold" width={200} height={200} className=" w-6 rounded-full   " /> </ConnectButton>
                    <ConnectWithGoogle setShowModal={setShowModal} variant="default" className="w-full flex items-center gap-2">Connect with google <Image src={"/logo/Google__G__logo.png"} alt="Aptos-Scaffold" width={200} height={200} className=" w-6 rounded-full   " /> </ConnectWithGoogle>
