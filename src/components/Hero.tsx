...
export default function Hero() {
    return (
        <section className="w-full h-screen bg-[var(--background)] my-3 flex items-center justify-center text-center font-space-grotesk relative " >
            <div className="w-full max-w-2xl flex flex-col items-center gap-6 " >
                <h1 className="text-6xl font-bold " >Build and launch your DApps <span className="text-transparent bg-clip-text md:bg-[linear-gradient(90deg,#D3A86C_0%,#91C8CA_22%,#9FE0D1_58%,#D3A86C_100%)]" > 5x faster</span></h1>
                <p className="text-lg text-white/90 md:px-7">
